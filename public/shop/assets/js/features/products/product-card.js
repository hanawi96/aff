    ...
    return `
        <div class="product-card" data-product-id="${product.id}">
            <div class="product-image-wrapper">
                <div class="product-image-container">
                    <img src="${imageUrl}" 
                         ...
                         class="product-image"
                         loading="lazy"
                         onclick="window.previewProductImage('${imageUrl}', '${escapeHtml(product.name)}', ${product.id}, {price: ${product.price}, originalPrice: ${product.original_price || product.price}, discountPercent: ${discount}})"
            ...
            <div class="product-info">
                <h3 class="product-name" onclick="window.previewProductImage('${imageUrl}', '${escapeHtml(product.name)}', ${product.id}, {price: ${product.price}, originalPrice: ${product.original_price || product.price}, discountPercent: ${discount}})" style="cursor: pointer;">${escapeHtml(product.name)}</h3>
