    ...
    return `
        <div class="product-card" data-product-id="${product.id}">
            <div class="product-image-wrapper">
                <div class="product-image-container">
                    <img src="${imageUrl}" 
                         ...
                         class="product-image"
                         loading="lazy"
                         onclick="window.previewProductImage('${imageUrl}', '${escapeHtml(product.name)}', ${product.id})"
            ...
            <div class="product-info">
                <h3 class="product-name" onclick="window.previewProductImage('${imageUrl}', '${escapeHtml(product.name)}', ${product.id})" style="cursor: pointer;">${escapeHtml(product.name)}</h3>
