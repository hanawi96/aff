                ...
                <div class="product-card" data-product-id="${product.id}">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-button-actions">
                            <button class="bundle-btn-primary" onclick="window.productActions && window.productActions.buyNow(${product.id})">
                            ...
                            <button class="bundle-btn-cart" onclick="window.productActions && window.productActions.addToCart(${product.id})" title="Thêm vào giỏ hàng">
