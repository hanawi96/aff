...
/** Tồn kho mặc định khi mở form thêm sản phẩm mới */
const DEFAULT_NEW_PRODUCT_STOCK = 99;
/** Đánh giá mặc định (0–5) khi thêm sản phẩm mới */
const DEFAULT_NEW_PRODUCT_RATING = 5;
                    ...
                    <div class="bg-white rounded-lg p-5 border border-gray-200 shadow-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="text" id="productStockQuantity" value="${formatNumber(DEFAULT_NEW_PRODUCT_STOCK)}"
                                    class="w-full px-3.5 py-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
                                    placeholder="15"
                                    oninput="autoFormatNumberInput(this)"
                                    onpaste="setTimeout(() => autoFormatNumberInput(this), 0)">
                            ...
                            <div>
                                ...
                                <input type="number" id="productRating" min="0" max="5" step="0.1" value="${DEFAULT_NEW_PRODUCT_RATING}"
                                    class="w-full px-3.5 py-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all"
                                    placeholder="4.9">
                            </div>
                            <div>
