...
const _CUSTOMER_SOURCE_DEFAULT = 'facebook';
...
function initCustomerSourcePicker(seedSource, opts = {}) {
    const initial = opts.isEdit
        ? normalizeCustomerSourceClient(seedSource)
        : _CUSTOMER_SOURCE_DEFAULT;
    setCustomerSourceSelection(initial);
}
