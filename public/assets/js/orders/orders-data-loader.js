...
function _ordersSignature(list) {
    ...
    for (const o of sorted) {
        const s = `${o.id}|${o.status || ''}|${o.total_amount || 0}|${o.is_priority || 0}|${o.shipped_at_unix || 0}|${o.customer_source || ''}|${(o.products && o.products.length) || 0}|${(o.notes && o.notes.length) || 0}|${o.manual_invoice_exported || 0}`;
